...
[![My Skills](https://skillicons.dev/icons?i=js,html,css,vite,react,git,aws,django,discord,figma,flask,fortran,github,java,md,mysql,nodejs,npm,postgres,py,sqlite,)](https://skillicons.dev)
